 ...
 * @type {string}
 */
module.exports.TITLE = 'One Small Step';

/**
 * Default subtitle
 * @type {string}
 */
module.exports.SUBTITLE = 'Please check the box below to continue your normal visit';
 ...
 * @type {string}
 */
module.exports.SUFFIX = 'If you\'re still having trouble accessing the site, please contact customer support.';
